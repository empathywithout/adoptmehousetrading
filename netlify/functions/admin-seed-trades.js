...
const TRADES = [
  ...
  // These are the only trades that directly involve ride pots -- they pin the scale
  // Real trades: people swap potions for potions or potions for cheap pets constantly
  // Fly pot for 2 ride pots (2 vs 2) -- very common
  [[pot("fly-a-pet-potion")], [pot("ride-a-pet-potion"), pot("ride-a-pet-potion")], "high"],
  // Sugar skull for 2 fly pots (4 vs 4) -- common
  [[pot("sugar-skull-potion")], [pot("fly-a-pet-potion"), pot("fly-a-pet-potion")], "high"],
  // Sugar skull + ride for 3 fly pots (5 vs 6 -- slight under, common)
  [[pot("sugar-skull-potion"), pot("ride-a-pet-potion")], [pot("fly-a-pet-potion"), pot("fly-a-pet-potion"), pot("fly-a-pet-potion")], "medium"],
  // Capybara + ride for axolotl (9 vs 20 -- realistic lowball trade)
  [[pet("capybara"), pot("ride-a-pet-potion")], [pet("axolotl")], "medium"],
  // Axolotl for monkey + 2 fly pots (20 vs 24 -- slight under)
  [[pet("axolotl")], [pet("monkey"), pot("fly-a-pet-potion"), pot("fly-a-pet-potion")], "medium"],
  // Monkey for axolotl + ride pot (20 vs 21 -- fair)
  [[pet("monkey")], [pet("axolotl"), pot("ride-a-pet-potion")], "high"],
